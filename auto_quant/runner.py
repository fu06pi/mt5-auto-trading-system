...
DEFAULT_BASE_PLAN = {
    ...
    "cmd": [
        ...
        "--risk-pct", "0.0085",
        "--stop-atr", "3.2",
        "--reward-multiple", "1.45",
        "--tp-min-usd", "14.0",
        "--tp-max-usd", "34.0",
        "--long-bias", "0.74",
        "--trend-threshold", "0.68",
    ...
    "state_file": str(ROOT / "mt5_doomsday_strategy_state.json"),
    "strategy_file": str(STRATEGIES_DIR / "mt5_doomsday_strategy.py"),
    "strategy_class": "DoomsdayMT5Strategy",
    "kind": "baseline",
    "generation": 0,
    "parent": None,
}
...
def _evaluate_plan(plan: Dict[str, Any]) -> CandidateResult:
    ...
    return CandidateResult(
        ...
        strategy_path=Path(str(plan.get("strategy_file", STRATEGIES_DIR / "mt5_doomsday_strategy.py"))),
    )
