...
- Portfolio total exposure cap 0.70 lot.
...
def load_current_params() -> base.Params:
    ...
    return base.Params(
        name="current_copy_rr1_fixed_0_1_tp500_cap0_7",
...
def close_trade(pos: Dict[str, Any], i: int, nxt: base.Bar, params: base.Params) -> Optional[Tuple[base.Trade, float]]:
    ...
    trade = base.Trade(
        strategy="current_copy_rr1_fixed_0_1_tp500_cap0_7",
        signal_source=str(pos["source"]),
        entry_time=str(pos["entry_time"]),
...
def main() -> None:
    ...
    summary_path = OUT_DIR / "current_copy_rr1_fixed_0_1_tp500_cap0_7_summary.csv"
    trades_path = OUT_DIR / "current_copy_rr1_fixed_0_1_tp500_cap0_7_trades.csv"
    json_path = OUT_DIR / "current_copy_rr1_fixed_0_1_tp500_cap0_7_diagnostics.json"
